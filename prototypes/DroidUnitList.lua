...
spawnable = {"basic-marine", "medium-marine", "heavy-marine", "droid-smg", "droid-rocket", "droid-rifle", "terminator", "droid-flame", "defender-unit", "distractor-unit", "destroyer-unit"}

--which of our custom entities can join squads? not necessarily all droids will be using the squad mechanic
squadCapable = {"basic-marine", "medium-marine", "heavy-marine", "droid-smg", "droid-rocket","droid-rifle", "terminator", "droid-flame", "defender-unit", "distractor-unit", "destroyer-unit"}
