data:extend(
{
...

  {
    ...
    name = "droid-smg",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/droid_smg_undep.png",
  ...
  },
  {
    ...
    name = "droid-flame",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/droid_flame_undep.png",
    flags = {"goes-to-quickbar"},
    order = "z[droid]",
	subgroup = "robotArmyDroid",
  ...
  },
  {
    ...
    name = "droid-rifle",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/droid_rifle_undep.png",
    flags = {"goes-to-quickbar"},
    order = "z[droid]",
	subgroup = "robotArmyDroid",
  ...
  },
  {
    ...
    name = "droid-rocket",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/droid_rocket_undep.png",
    flags = {"goes-to-quickbar"},
    order = "z[droid]",
	subgroup = "robotArmyDroid",
  ...
  },
  {
    ...
    name = "terminator",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/terminator_undep.png",
    flags = {"goes-to-quickbar"},
    order = "z[droid]",
	subgroup = "robotArmyDroid",
	...
	
	{
		...
		name = "defender-unit",
        icon_size = 32,
		icon = "__ColonistsArmy__/graphics/icons/defender_unit_undep.png",
		flags = {"goes-to-quickbar"},
		order = "x[combatrobot]",
		subgroup = "robotArmyDroid",
	...
	
	{
        ...
        icon_size = 32,
		icon = "__ColonistsArmy__/graphics/icons/distractor_unit_undep.png",
		flags = {"goes-to-quickbar"},
		order = "y[combatrobot]",
		subgroup = "robotArmyDroid",
	...
	},
	{
		...
		name = "destroyer-unit",
        icon_size = 32,
		icon = "__ColonistsArmy__/graphics/icons/destroyer_unit_undep.png",
		flags = {"goes-to-quickbar"},
		order = "z[combatrobot]",
		subgroup = "robotArmyDroid",
  ...
  },
  {
    ...
    name = "patrol-pole",
    icon_size = 32,
    icon = "__ColonistsArmy__/graphics/icons/patrol-pole.png",
    flags = {"goes-to-quickbar"},
    subgroup = "robotArmyBuildings",
    ...
    icon_size = 32,
	icon = "__ColonistsArmy__/graphics/icons/selection_tool.png",
	flags = {"goes-to-quickbar"},
	subgroup = "robotArmyBuildings",
    ...
    icon_size = 32,
	icon = "__ColonistsArmy__/graphics/icons/pickup_tool.png",
	flags = {"goes-to-quickbar"},
	subgroup = "robotArmyBuildings",
